...
const SERVICES = [
  ...
  { num: '06', title: 'Umrah Services',      desc: 'Meticulously designed pilgrimage travel, featuring luxury hotels close to the Haram, smooth VIP airport transfers, and visa processing.', img: '/dest-muscat.jpg' },
];
      ...
      <main>
        ...
        <section className={styles.servSection}>
          <div className={styles.servHeader}>
            ...
            {/* Giant script behind */}
            <div className={styles.servScript} aria-hidden="true">
              services
            </div>
          </div>
        ...
        <section className={styles.diarySection}>
          <div className={styles.diaryHeader}>
            ...
            {/* Giant script — dark bg version */}
            <div className={styles.diaryGiantScript} aria-hidden="true">
              Travel Diaries
            </div>
