      ...
      <div className="container-wide">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16 sm:mb-20">
          <div className="max-w-2xl space-y-4">
            ...
            <Reveal delay={0.06}>
              <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-[3.35rem] font-medium tracking-tight text-[#0F2E23] leading-[1.08]">
                {locale === 'ar' ? 'فن السفر الانسيابي، من الرؤية إلى العودة بالسلامة.' : 'The Art of Seamless Travel, From Vision to Touchdown.'}
              </h2>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              <p className="text-base sm:text-lg text-[#0F2E23]/75 font-light max-w-xl leading-relaxed font-sans">
                {locale === 'ar'
                  ? 'منهجية كونسيرج مخصصة مصممة لإزالة أي عناء، وحماية وقتك الثمين، والارتقاء بكل لحظة.'
          ...
          <Reveal delay={0.15}>
            ...
            >
              <span>{locale === 'ar' ? 'المزيد عنا' : 'More about us'}</span>
              <span className="w-8 h-8 rounded-full bg-[#0F2E23] text-white group-hover:bg-[#39C27D] group-hover:text-[#0F2E23] flex items-center justify-center transition-transform duration-300 group-hover:rotate-45 rtl:group-hover:-rotate-45">
