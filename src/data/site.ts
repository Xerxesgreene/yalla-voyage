export const siteConfig = {
  ...
  address: {
    ...
    full: 'Al-Madinah Al-Munawarah road, Al-Ruwais, Jeddah 23214',
  },
  nav: [
    { label: 'Destinations', href: '/destinations' },
    { label: 'Experiences', href: '/explore-saudi' },
    { label: 'Services', href: '/services' },
    { label: 'About Us', href: '/about' },
    { label: 'Explore Saudi', href: '/explore-saudi' },
...
export const whyUsItems = [
  ...
  },
  {
    ...
    description:
      'We\'re not a one-time booking service. We\'re your go-to travel partner for every journey that follows.',
    icon: 'Heart',
  },
];
